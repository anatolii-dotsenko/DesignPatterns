...
// --------------------------------------------------------------------------
public class FireKnight : Knight
{
...
// --------------------------------------------------------------------------
public class FireUnitFactory : UnitFactory
{
    public override Knight CreateKnight() => new FireKnight();
    public override Mage CreateMage() => new FireMage();
    public override Archer CreateArcher() => new FireArcher();
}

public class IceUnitFactory : UnitFactory
{
    public override Knight CreateKnight() => new IceKnight();
    public override Mage CreateMage() => new IceMage();
